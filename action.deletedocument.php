...
if (!$this->CheckPermission('Use Document Search'))
  {
    echo $this->ShowErrors($this->Lang('needpermission', array('Use Document Search')));
    return;
  }
...
documentsearch_admin_ops::delete_document($documentid);

$params = array('tab_message'=> 'documentdeleted', 'active_tab' => 'general');
